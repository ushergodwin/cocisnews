								...
								<tbody>
									<tr>
										...
										<td style="display:flex;">
											...
											<form action="" method="POST" onsubmit="return confirm('Delete Post? \n Action can not be undone!');">
												<input type="hidden" name="pid" value="<?php echo $pid; ?>" />
												<button style="color:white;text-decoration:none;" type="submit" class="btn btn-outline-light btn-sm" name="delete">
